...
// A strobe filter segment.

struct strobe_filter_segment: public intersectable
{
	...
	strobe_filter_segment(point _p1, point _p2)
	{
		type = intersectable_strobe_filter_segment;
