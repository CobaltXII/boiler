...
**To all users:** It has been reported that screen flickering sometimes occurs when updating the frame buffer with greatly differing contents. This is only known to occur on macOS. 
